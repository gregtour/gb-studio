...
SCRIPT_CMD script_cmds[] = {
    ...
    {Script_SoundStartTone_b, 2},     // 0x55
    {Script_SoundStopTone_b, 0},      // 0x56
    {Script_SoundPlayBeep_b, 1},      // 0x57
    {Script_SoundPlayCrash_b, 0},     // 0x58
    {Script_SetTimerScript_b, 4},     // 0x59
    {Script_ResetTimer_b, 0},         // 0x5A
    {Script_RemoveTimerScript_b, 0},  // 0x5B
};
